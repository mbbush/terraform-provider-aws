...
* `automatic_model_registration` - (Optional) Whether automatic registration of new MLflow models to the SageMaker Model Registry is enabled. Defaults to False.
